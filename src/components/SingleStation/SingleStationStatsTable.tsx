            ...
            <Table sx={{ minWidth: 450 }} aria-label="table of the station" size="small">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>Mean duration</TableCell>
                        <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>Median dist</TableCell>
                        <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>Median duration</TableCell>
                ...
                <TableBody>
                        ...
                        > <TableCell component="th" scope="row">
                            ...
                            <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>{(Math.floor(mean_duration) / 60).toFixed(2)} min</TableCell>
                            <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>{median_distance} m</TableCell>
                            <TableCell align="right" sx={{display: { xs: 'none', md: 'table-cell'}}}>{(Math.floor(median_duration) / 60).toFixed(2)} min</TableCell>
                        </TableRow>
                </TableBody>
            </Table>
        </TableContainer>
